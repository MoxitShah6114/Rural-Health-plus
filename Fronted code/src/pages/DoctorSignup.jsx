...
// Add this new styled component for the password requirements container
...
export const DoctorSignup = () => {
  ...
  // Add this new state to track password field focus
  ...
  const handlePasswordBlur = () => {
    // Only hide requirements if password is empty or already strong
    if (formData.password.length === 0 || passwordStrength === 100) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log("Submitting doctor signup form...");
      ...
      <FormCard>
        ...
        <SignupForm onSubmit={handleSubmit}>
          <FormGrid>
            ...
            {/* Security Information - Updated Password Section */}
            <FormGroup>
              <FormLabel>
              ...
              <PasswordRequirementsContainer visible={passwordFocused || (formData.password.length > 0 && passwordStrength < 100)}>
